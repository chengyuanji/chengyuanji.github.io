...
#slides: example
---
 <img alt = '' width='100%' src='featured.png'  style="margin-left:auto; margin-right:auto"/>  <!-- using the 'built in' feature decreases the quality; so set preview_only to yes and add image here --> 
...
<div class="row">
  ...
  <img alt = '' width='90%' src='ex2.png'  style="margin: 15px"/>
  </div>
  <div class="col-md-4" style="text-align:center;">
